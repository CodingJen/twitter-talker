...
function pressStart(tweet) {
  ...
  if (text.includes(twitterUsername) && playerTwo === true) {
    ...
    var replyText =
      '@' + name + " Here's your soundtrack: " + soundtrackArray[soundtrackArrayElement];
...
function pressSelect() {
  ...
  var soundtrackArrayElement = Math.floor(Math.random() * soundtrackArrayLength);
  var weeklyText =
    soundtrackArray[soundtrackArrayElement] + " Here's your soundtrack for " + dateString;
